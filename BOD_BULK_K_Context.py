{
  ...
  "properties": {
    ...
    "P3_TRK_GROSS_TIMESTAMP": "gross_timestamp",
    "TRUCK_BRAND": "truck_brand",
    "P3_TRK_SEAL_NR": "tarp_seal",
    "P3_TRK_GROSS_MASS_KG": "gross_mass",
    "P3_TRK_NET_MASS_KG": "nett_mass",
    "TRUCK": "component_name"
  },
  "component_types": [
    {
      "type_id": "6215b5a1-86dc-4bd6-ae2b-e017ab9d8a4f",
      "type_alias": "p3_internal_bulk_lot",
      "attributes": {
        "name": "p3_internal_bulk_lot_id"
      }
    }
  ],
  "functions": {
